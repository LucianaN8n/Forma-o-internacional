...
export const ELIGIBLE_COURSES: EligibleCourse[] = [
  {
    ...
    shortDescription: "Ministrado pela Profª. Ana Esteves e pelo Prof. Francisco Miguel Kessler. Compreenda o funcionamento cerebral, neuroplasticidade, regulação emocional e intervenções clínicas de ponta com chancela internacional.",
    fullDescription: "Ministrado pela Profª. Ana Esteves (Psicoterapeuta, Psicanalista e Aplicadora ABA) e pelo Prof. Francisco Miguel Kessler (Hipnoterapeuta Internacional e Especialista em Neurociência), esta é uma formação profunda e científica que une as descobertas mais recentes da neurobiologia moderna à prática terapêutica, capacitando você a entender e intervir nos circuitos neurais, reprogramação de hábitos, regulação de ansiedade, estresse e funções executivas.",
  ...
  },
  {
    ...
    shortDescription: "Ministrado pela Profª. Ana Esteves, Prof. Francisco Kessler (Terapia Quântica), Prof. Rogério Temporim (Cristaloterapia), Profª. Mariana Sallum e corpo docente do Instituto Saber Consciente ®. Formação completa com 35 técnicas consagradas em Terapias Mentais, Corporais e Energéticas, com carga de 568h e diploma emitido nos EUA.",
    fullDescription: "Ministrado pela Profª. Ana Esteves, Prof. Francisco Kessler (Terapia Quântica), Prof. Rogério Temporim (Cristaloterapia), Profª. Mariana Sallum (Aromaterapia, Cromoterapia e Práticas Corporais) e renomados especialistas do Instituto Saber Consciente ®, este é o programa de formação de terapeutas holísticos mais conceituado e completo do mercado. Você dominará 35 técnicas fundamentais divididas em 3 grandes eixos de atuação clínica: Terapias Mentais e Emocionais, Terapias Corporais e Terapias Energéticas, capacitando você para atendimentos presenciais e online de alto impacto.",
  ...
  },
  {
    ...
    shortDescription: "Ministrado pelo Prof. Rogério Temporim e Profª. Ana Esteves. Formação aprofundada de 600h cobrindo 24 pilares clínicos essenciais com supervisão ao vivo e chancela internacional.",
    fullDescription: "Ministrado pelo Prof. Rogério Temporim (Mestre em Psicologia Clínica pela CBS Flórida/EUA e graduado pela USP) e pela Profª. Ana Esteves (Psicanalista e Terapeuta Comportamental), esta é uma imersão completa e rigorosa na prática psicanalítica e abordagens psicoterapêuticas contemporâneas. Você terá acesso a 24 eixos fundamentais que vão desde a clínica de base e psicopatologias até técnicas avançadas de atendimento, supervisão de casos (1 aula online ao vivo por mês), logoterapia e diversidade.",
